...
import 'package:crush/screens/edit_profile.dart';
                ...
                children: [
                  ...
                  Container(
                    padding: EdgeInsets.only(right:240),
                      child: Text("Terms & Condition", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 16.0))),
                  SizedBox(height: 35.0),
                  Container(
                    padding: EdgeInsets.only(right: 250),
                      child: Text("Privacy & Policy", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 16.0))),
